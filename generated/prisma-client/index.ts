...
export interface Prisma {
  ...
  forumPost: (where: ForumPostWhereUniqueInput) => ForumPostPromise;
  forumPosts: (
    args?: {
...
export interface ForumWhereInput {
  ...
  avatarPic_in?: String[] | String;
  avatarPic_not_in?: String[] | String;
  avatarPic_lt?: String;
  ...
  coverPic?: String;
  coverPic_not?: String;
  coverPic_in?: String[] | String;
  coverPic_not_in?: String[] | String;
  coverPic_lt?: String;
  coverPic_lte?: String;
  coverPic_gt?: String;
  coverPic_gte?: String;
...
export interface ForumPostSubscriptionWhereInput {
  ...
  AND?: ForumPostSubscriptionWhereInput[] | ForumPostSubscriptionWhereInput;
  OR?: ForumPostSubscriptionWhereInput[] | ForumPostSubscriptionWhereInput;
  NOT?: ForumPostSubscriptionWhereInput[] | ForumPostSubscriptionWhereInput;
}
...
export interface ForumPostWhereInput {
  ...
  type_in?: ForumPostType[] | ForumPostType;
  type_not_in?: ForumPostType[] | ForumPostType;
  AND?: ForumPostWhereInput[] | ForumPostWhereInput;
  OR?: ForumPostWhereInput[] | ForumPostWhereInput;
...
export interface ForumPostUpdateManyWithoutPostedByInput {
  create?:
    | ForumPostCreateWithoutPostedByInput[]
    | ForumPostCreateWithoutPostedByInput;
...
export interface UserUpdateManyWithoutForumsInput {
  create?: UserCreateWithoutForumsInput[] | UserCreateWithoutForumsInput;
  delete?: UserWhereUniqueInput[] | UserWhereUniqueInput;
  connect?: UserWhereUniqueInput[] | UserWhereUniqueInput;
  set?: UserWhereUniqueInput[] | UserWhereUniqueInput;
  disconnect?: UserWhereUniqueInput[] | UserWhereUniqueInput;
...
export interface ForumPostScalarWhereInput {
  ...
  OR?: ForumPostScalarWhereInput[] | ForumPostScalarWhereInput;
...
export interface ForumUpdateManyWithoutMembersInput {
  create?: ForumCreateWithoutMembersInput[] | ForumCreateWithoutMembersInput;
  ...
  updateMany?:
    | ForumUpdateManyWithWhereNestedInput[]
    | ForumUpdateManyWithWhereNestedInput;
}
...
export interface ForumPostUpdateManyWithoutForumInput {
  create?:
    | ForumPostCreateWithoutForumInput[]
    | ForumPostCreateWithoutForumInput;
  delete?: ForumPostWhereUniqueInput[] | ForumPostWhereUniqueInput;
  connect?: ForumPostWhereUniqueInput[] | ForumPostWhereUniqueInput;
  set?: ForumPostWhereUniqueInput[] | ForumPostWhereUniqueInput;
...
export interface ForumScalarWhereInput {
  ...
  OR?: ForumScalarWhereInput[] | ForumScalarWhereInput;
...
export interface ForumPromise extends Promise<Forum>, Fragmentable {
  ...
  posts: <T = FragmentableArray<ForumPost>>(
    args?: {
      where?: ForumPostWhereInput;
      orderBy?: ForumPostOrderByInput;
      skip?: Int;
...
export interface ForumSubscription
  ...
  posts: <T = Promise<AsyncIterator<ForumPostSubscription>>>(
    args?: {
      where?: ForumPostWhereInput;
      orderBy?: ForumPostOrderByInput;
      skip?: Int;
...
export interface UserPromise extends Promise<User>, Fragmentable {
  ...
  forumposts: <T = FragmentableArray<ForumPost>>(
    args?: {
      where?: ForumPostWhereInput;
      orderBy?: ForumPostOrderByInput;
      skip?: Int;
  ...
  forums: <T = FragmentableArray<Forum>>(
    args?: {
      where?: ForumWhereInput;
      orderBy?: ForumOrderByInput;
      skip?: Int;
...
export interface UserSubscription
  ...
  forumposts: <T = Promise<AsyncIterator<ForumPostSubscription>>>(
    args?: {
      where?: ForumPostWhereInput;
      orderBy?: ForumPostOrderByInput;
      skip?: Int;
  ...
  forums: <T = Promise<AsyncIterator<ForumSubscription>>>(
    args?: {
      where?: ForumWhereInput;
      orderBy?: ForumOrderByInput;
      skip?: Int;
